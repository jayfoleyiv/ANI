...
*/
  ...
  FILE *rfpr, *rfpi;
  rfpr = fopen("July6/10-atom_epsilon/epsr.dat","r");
  rfpi = fopen("July6/10-atom_epsilon/epsi.dat","r");
  thetaI = 0.;
  ...
  for (i=0; i<fdim; i++) {
     ...
     fprintf(fp,"  %12.10f %12.10f  %12.10f %12.10f  %12.10f  %12.10f\n",thetaI*180./pi,lambda,refl, Trans,epsr, epsi);
  }
